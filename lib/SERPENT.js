...
function rotl(value, shift) {
    ...
    const return_value = ((value2 << shift) | (value2 >>> (32 - shift))) >>> 0;
    return return_value
}
...
class Serpent {
    constructor() {
        ...
        this.SBOX0 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
        ...
        this.SBOX1 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.SBOX2 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.SBOX3 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.SBOX4 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.SBOX5 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                readUInt32LE(this.r0 = this.buffer, a);
                readUInt32LE(this.r1 = this.buffer, b);
                readUInt32LE(this.r2 = this.buffer, c);
                readUInt32LE(this.r3 = this.buffer, d);
            }
            this.r4 = 0;
        ...
        this.SBOX6 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.SBOX7 = function (a, b, c, d, usevalue) {
            if (!usevalue) {
                this.r0 = readUInt32LE(this.buffer, a);
                this.r1 = readUInt32LE(this.buffer, b);
                this.r2 = readUInt32LE(this.buffer, c);
        ...
        this.LT = function (a, b, c, d) {
            this.x0 = this[a];
            this.x1 = this[b];
            this.x2 = this[c];
            this.x3 = this[d];
            this.x0 = rotl(this.x0 >>> 0, 13, `LT1`);
            this.x2 = rotl(this.x2 >>> 0, 3, `LT2`);
            this.x1 ^= this.x0 ^ this.x2;
            this.x3 ^= this.x2 ^ (this.x0 << 3);
            this.x3 = rotl(this.x3 >>> 0, 7, `LT3`);
            this.x1 = rotl(this.x1 >>> 0, 1, `LT4`);
            this.x0 ^= this.x1 ^ this.x3;
            this.x2 ^= this.x3 ^ (this.x1 << 7);
            this.x0 = rotl(this.x0 >>> 0, 5, `LT5`);
            this.x2 = rotl(this.x2 >>> 0, 22, `LT6`);
            this[a] = this.x0;
            this[b] = this.x1;
            this[c] = this.x2;
            this[d] = this.x3;
