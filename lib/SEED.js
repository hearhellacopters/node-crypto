...
const readUInt32BE = (array, index) =>{
...
class SEED {
    constructor() {
        ...
        const G = function (x) {
            return (ss0[(x) & 0xFF] ^ ss1[((x) >> 8) & 0xFF] ^ ss2[((x) >> 16) & 0xFF] ^ ss3[((x) >> 24) & 0xFF]) >>> 0;
        };
        ...
        this.set_key = function (key) {
            ...
            do {
                ...
                t_1[0] = G(bswap32(t_0[0]));
                t_2[0] = G(bswap32(t_4[0]));
        ...
        this.encrypt_block = function (block) {
            ...
            do {
                ...
                this.t6[0] = ss1[BYTE2(this.t5[0])] ^ ss0[HIBYTE(this.t5[0])] ^ ss2[BYTE1(this.t5[0])] ^ ss3[BYTE(this.t5[0])]
                this.t7[0] = this.t6[0] + this.t4[0]
                this.t7[0] = bswap32(this.t7[0])
                this.t8[0] = ss1[BYTE2(this.t7[0])] ^ ss0[HIBYTE(this.t7[0])] ^ ss2[BYTE1(this.t7[0])] ^ ss3[BYTE(this.t7[0])]
                this.t9[0] = this.t8[0] + this.t6[0]
                this.t9[0] = bswap32(this.t9[0])
                this.t10[0] = ss1[BYTE2(this.t9[0])] ^ ss0[HIBYTE(this.t9[0])] ^ ss2[BYTE1(this.t9[0])] ^ ss3[BYTE(this.t9[0])]
