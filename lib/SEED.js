...
class SEED {
    constructor() {
        ...
        this.F = function (k0, k1, r0, r1, t0, t1) {
            this[t1] = (((this[r0] ^ k0) >>> 0) ^ ((this[r1] ^ k1) >>> 0)) >>> 0;
            this[t1] = G(this[t1]);
            this[t0] = (this[t1] + ((this[r0] ^ k0) >>> 0)) >>> 0;
            this[t0] = G(this[t0]);
            this[t1] = (this[t1] + this[t0]) >>> 0;
            this[t1] = G(this[t1]);
            this[t0] = (this[t0] + this[t1]) >>> 0;
        };
        ...
        this.set_key = function (key) {
            ...
            this.key0 = readUInt32LE(key, 0);
            this.key1 = readUInt32LE(key, 4);
            this.key2 = readUInt32LE(key, 8);
            this.key3 = readUInt32LE(key, 12);
            ...
            for (i = 0; i < 16; i++) {
                let ks_seed = kc[i];
                let t_0 = (this.key0 + this.key2 - ks_seed) >>> 0;
                let t_4 = (this.key1 + this.key3 + kc[i]) >>> 0;
                let t_1 = G(t_0);
                let t_2 = G(t_4);
                writeUInt32LE(this.buffer, t_1, offset);
                writeUInt32LE(this.buffer, t_2, 4 + offset);
                if ((i & 1) != 0) {
                    let t_3 = __PAIR64__(this.key3, this.key2, 24);
                    this.key2 = (__PAIR64__(this.key2, this.key3, 24)) >>> 0;
                    this.key3 = t_3 >>> 0;
                } else {
                    let t_5 = __PAIR64__(this.key0, this.key1, 8);
                    this.key0 = (__PAIR64__(this.key1, this.key0, 8)) >>> 0;
                    this.key1 = t_5 >>> 0;
                }
                offset = offset + 8;
            }
        ...
        this.encrypt_block = function (block) {
            ...
            this.l0 = readUInt32BE(start_chunk, 0);
            this.l1 = readUInt32BE(start_chunk, 4);
            this.r0 = readUInt32BE(start_chunk, 8);
            this.r1 = readUInt32BE(start_chunk, 12);
            ...
            let i;
            for (i = 0; i < 16; i++) {
                let ks0 = readUInt32LE(this.buffer, offset);
                let ks1 = readUInt32LE(this.buffer, offset + 4);
                this.F(ks0, ks1, "r0", "r1", "t0", "t1");
                this.t0 = (this.t0 ^ this.l0) >>> 0;
                this.t1 = (this.t1 ^ this.l1) >>> 0;
                this.l0 = this.r0;
                this.l1 = this.r1;
                this.r0 = this.t0;
                this.r1 = this.t1;
