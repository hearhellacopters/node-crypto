...
class Camellia {
    ...
    /*private*/ static rightRotate(x, s) {
        return (((x) >>> (s)) + ((x) << (32 - s)));
    }
    /*private*/ static leftRotate(x, s) {
        return (((x) << (s)) + ((x) >>> (32 - s)));
    }
    /*private*/ static roldq(rot, ki, ioff, ko, ooff) {
    ...
    /*private*/ static decroldq(rot, ki, ioff, ko, ooff) {
    ...
    /*private*/ static roldqo32(rot, ki, ioff, ko, ooff) {
    ...
    /*private*/ static decroldqo32(rot, ki, ioff, ko, ooff) {
    ...
    /*private*/ bytes2int(src, offset) {
        var word = new Uint32Array(1);
        for (var i = 0; i < 4; i++) {
            {
                word[0] = (word[0] << 8) + (src[i + offset] & Camellia.MASK8);
            }
            ;
        }
        return word[0];
    }
    /*private*/ int2bytes(word, dst, offset) {
        for (var i = 0; i < 4; i++) {
            {
    ...
    /*private*/ camelliaF2(s, skey, keyoff) {
        var t1;
        var t2;
        var u;
        var v;
        t1 = s[0] ^ skey[0 + keyoff];
        u = Camellia.SBOX4_4404[t1 & Camellia.MASK8];
        u ^= Camellia.SBOX3_3033[(t1 >>> 8) & Camellia.MASK8];
        u ^= Camellia.SBOX2_0222[(t1 >>> 16) & Camellia.MASK8];
        u ^= Camellia.SBOX1_1110[(t1 >>> 24) & Camellia.MASK8];
        t2 = s[1] ^ skey[1 + keyoff];
        v = Camellia.SBOX1_1110[t2 & Camellia.MASK8];
        v ^= Camellia.SBOX4_4404[(t2 >>> 8) & Camellia.MASK8];
        v ^= Camellia.SBOX3_3033[(t2 >>> 16) & Camellia.MASK8];
        v ^= Camellia.SBOX2_0222[(t2 >>> 24) & Camellia.MASK8];
        s[2] ^= u ^ v;
        s[3] ^= u ^ v ^ Camellia.rightRotate(u, 8);
        ...
        v ^= Camellia.SBOX2_0222[(t2 >>> 24) & Camellia.MASK8];
        s[0] ^= u ^ v;
        s[1] ^= u ^ v ^ Camellia.rightRotate(u, 8);
    }
    /*private*/ camelliaFLs(s, fkey, keyoff) {
        s[1] ^= Camellia.leftRotate(s[0] & fkey[0 + keyoff], 1);
        s[0] ^= fkey[1 + keyoff] | s[1];
        s[2] ^= fkey[3 + keyoff] | s[3];
        s[3] ^= Camellia.leftRotate(fkey[2 + keyoff] & s[2], 1);
    }
    /*private*/ setkey(forEncryption, key) {
        ...
        this.camelliaF2(ka, Camellia.SIGMA, 0);
        for (var i = 0; i < 4; i++) {
            {
                ka[i] ^= k[i];
            }
        ...
        this.camelliaF2(ka, Camellia.SIGMA, 4);
        if (this._keyis128) {
            if (forEncryption) {
                this.kw[0] = k[0];
                this.kw[1] = k[1];
                this.kw[2] = k[2];
                this.kw[3] = k[3];
                Camellia.roldq(15, k, 0, this.subkey, 4);
                Camellia.roldq(30, k, 0, this.subkey, 12);
                Camellia.roldq(15, k, 0, t, 0);
                this.subkey[18] = t[2];
                this.subkey[19] = t[3];
                Camellia.roldq(17, k, 0, this.ke, 4);
                Camellia.roldq(17, k, 0, this.subkey, 24);
                Camellia.roldq(17, k, 0, this.subkey, 32);
                this.subkey[0] = ka[0];
                this.subkey[1] = ka[1];
                this.subkey[2] = ka[2];
                this.subkey[3] = ka[3];
                Camellia.roldq(15, ka, 0, this.subkey, 8);
                Camellia.roldq(15, ka, 0, this.ke, 0);
                Camellia.roldq(15, ka, 0, t, 0);
                this.subkey[16] = t[0];
                this.subkey[17] = t[1];
                Camellia.roldq(15, ka, 0, this.subkey, 20);
                Camellia.roldqo32(34, ka, 0, this.subkey, 28);
                Camellia.roldq(17, ka, 0, this.kw, 4);
            } else {
                this.kw[4] = k[0];
                this.kw[5] = k[1];
                this.kw[6] = k[2];
                this.kw[7] = k[3];
                Camellia.decroldq(15, k, 0, this.subkey, 28);
                Camellia.decroldq(30, k, 0, this.subkey, 20);
                Camellia.decroldq(15, k, 0, t, 0);
                this.subkey[16] = t[0];
                this.subkey[17] = t[1];
                Camellia.decroldq(17, k, 0, this.ke, 0);
                Camellia.decroldq(17, k, 0, this.subkey, 8);
                Camellia.decroldq(17, k, 0, this.subkey, 0);
                this.subkey[34] = ka[0];
                this.subkey[35] = ka[1];
                this.subkey[32] = ka[2];
                this.subkey[33] = ka[3];
                Camellia.decroldq(15, ka, 0, this.subkey, 24);
                Camellia.decroldq(15, ka, 0, this.ke, 4);
                Camellia.decroldq(15, ka, 0, t, 0);
                this.subkey[18] = t[2];
                this.subkey[19] = t[3];
                Camellia.decroldq(15, ka, 0, this.subkey, 12);
                Camellia.decroldqo32(34, ka, 0, this.subkey, 4);
                Camellia.roldq(17, ka, 0, this.kw, 0);
            }
        } else {
            for (var i = 0; i < 4; i++) {
                {
            ...
            this.camelliaF2(kb, Camellia.SIGMA, 8);
            if (forEncryption) {
                this.kw[0] = k[0];
                this.kw[1] = k[1];
                this.kw[2] = k[2];
                this.kw[3] = k[3];
                Camellia.roldqo32(45, k, 0, this.subkey, 16);
                Camellia.roldq(15, k, 0, this.ke, 4);
                Camellia.roldq(17, k, 0, this.subkey, 32);
                Camellia.roldqo32(34, k, 0, this.subkey, 44);
                Camellia.roldq(15, k, 4, this.subkey, 4);
                Camellia.roldq(15, k, 4, this.ke, 0);
                Camellia.roldq(30, k, 4, this.subkey, 24);
                Camellia.roldqo32(34, k, 4, this.subkey, 36);
                Camellia.roldq(15, ka, 0, this.subkey, 8);
                Camellia.roldq(30, ka, 0, this.subkey, 20);
                this.ke[8] = ka[1];
                this.ke[9] = ka[2];
                this.ke[10] = ka[3];
                this.ke[11] = ka[0];
                Camellia.roldqo32(49, ka, 0, this.subkey, 40);
                this.subkey[0] = kb[0];
                this.subkey[1] = kb[1];
                this.subkey[2] = kb[2];
                this.subkey[3] = kb[3];
                Camellia.roldq(30, kb, 0, this.subkey, 12);
                Camellia.roldq(30, kb, 0, this.subkey, 28);
                Camellia.roldqo32(51, kb, 0, this.kw, 4);
            }
            else {
                this.kw[4] = k[0];
                this.kw[5] = k[1];
                this.kw[6] = k[2];
                this.kw[7] = k[3];
                Camellia.decroldqo32(45, k, 0, this.subkey, 28);
                Camellia.decroldq(15, k, 0, this.ke, 4);
                Camellia.decroldq(17, k, 0, this.subkey, 12);
                Camellia.decroldqo32(34, k, 0, this.subkey, 0);
                Camellia.decroldq(15, k, 4, this.subkey, 40);
                Camellia.decroldq(15, k, 4, this.ke, 8);
                Camellia.decroldq(30, k, 4, this.subkey, 20);
                Camellia.decroldqo32(34, k, 4, this.subkey, 8);
                Camellia.decroldq(15, ka, 0, this.subkey, 36);
                Camellia.decroldq(30, ka, 0, this.subkey, 24);
                this.ke[2] = ka[1];
                this.ke[3] = ka[2];
                this.ke[0] = ka[3];
                this.ke[1] = ka[0];
                Camellia.decroldqo32(49, ka, 0, this.subkey, 4);
                this.subkey[46] = kb[0];
                this.subkey[47] = kb[1];
                this.subkey[44] = kb[2];
                this.subkey[45] = kb[3];
                Camellia.decroldq(30, kb, 0, this.subkey, 32);
                Camellia.decroldq(30, kb, 0, this.subkey, 16);
                Camellia.roldqo32(51, kb, 0, this.kw, 0);
            }
        }
    ...
    /*private*/ processBlock192or256(__in) {
        for (var i = 0; i < 4; i++) {
            {
                this.state[i] = this.bytes2int(__in, (i * 4));
                this.state[i] ^= this.kw[i];
    ...
    getBlockSize() {
        return Camellia.BLOCK_SIZE;
    }
}
Camellia.SIGMA = new Uint32Array([
...
Camellia.SBOX1_1110 = new Uint32Array([
...
Camellia.SBOX4_4404 = new Uint32Array([
...
Camellia.SBOX2_0222 = new Uint32Array([
...
Camellia.SBOX3_3033 = new Uint32Array([
