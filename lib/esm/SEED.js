import { isBuffer, isBufferOrUint8Array, extendUint8Array, concatenateUint8Arrays, xor, writeUInt32LE, writeUInt32BE, readUInt32BE, readUInt32LE, bswap32, HIBYTE, BYTE2, BYTE1, BYTE, __PAIR64__, align, removePKCSPadding } from './common.js';
/**
 * SEED encryption.
 *
...
export class SEED {
    ...
    set_key(key) {
        ...
        key0[0] = readUInt32LE(key, 0);
        key1[0] = readUInt32LE(key, 4);
        key2[0] = readUInt32LE(key, 8);
        key3[0] = readUInt32LE(key, 12);
        ...
        do {
            ...
            if ((i & 1) != 0) {
                ...
                t_5[0] = __PAIR64__(key0[0], key1[0], 8);
                key0[0] = __PAIR64__(key1[0], key0[0], 8);
                key1[0] = t_5[0];
            }
            i++;
            offset += 8;
    ...
    encrypt_block(block) {
        ...
        this.l0[0] = readUInt32BE(start_chunk, 0);
        this.l1[0] = readUInt32BE(start_chunk, 4);
        this.r0[0] = readUInt32BE(start_chunk, 8);
        this.r1[0] = readUInt32BE(start_chunk, 12);
        ...
        do {
            ...
            this.l0[0] = this.r0[0];
            this.l1[0] = this.r1[0];
            this.t4[0] = readUInt32LE(this.buffer, i) ^ this.r0[0];
            this.t5[0] = readUInt32LE(this.buffer, i + 4) ^ this.r1[0] ^ this.t4[0];
            this.t5[0] = bswap32(this.t5[0]);
            this.t6[0] = this.ss1[BYTE2(this.t5[0])] ^ this.ss0[HIBYTE(this.t5[0])] ^ this.ss2[BYTE1(this.t5[0])] ^ this.ss3[BYTE(this.t5[0])];
            this.t7[0] = this.t6[0] + this.t4[0];
            this.t7[0] = bswap32(this.t7[0]);
            this.t8[0] = this.ss1[BYTE2(this.t7[0])] ^ this.ss0[HIBYTE(this.t7[0])] ^ this.ss2[BYTE1(this.t7[0])] ^ this.ss3[BYTE(this.t7[0])];
            this.t9[0] = this.t8[0] + this.t6[0];
            this.t9[0] = bswap32(this.t9[0]);
            this.t10[0] = this.ss1[BYTE2(this.t9[0])] ^ this.ss0[HIBYTE(this.t9[0])] ^ this.ss2[BYTE1(this.t9[0])] ^ this.ss3[BYTE(this.t9[0])];
        ...
        writeUInt32BE(out_blk, this.r0, 0);
        writeUInt32BE(out_blk, this.r1, 4);
        writeUInt32BE(out_blk, this.l0, 8);
        writeUInt32BE(out_blk, this.l1, 12);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
    ...
    decrypt_block(block) {
        ...
        writeUInt32BE(out_blk, (this.t10[0] + this.t8[0]) ^ this.t1[0], 0);
        writeUInt32BE(out_blk, this.r1, 4);
        writeUInt32BE(out_blk, this.l0, 8);
        writeUInt32BE(out_blk, this.l1, 12);
