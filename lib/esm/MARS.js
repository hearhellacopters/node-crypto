import { isBuffer, isBufferOrUint8Array, extendUint8Array, concatenateUint8Arrays, xor, readUInt32LE, writeUInt32LE, rotl, rotr, align, removePKCSPadding } from './common.js';
...
export class MARS {
    ...
    f_mix(a, b, c, d) {
        this.r = rotr(this[a], 16) & 0xff;
        this[b] = (this.s_box[this[a] & 0xff] ^ this[b]);
        this[b] = (this.s_box[(rotr(this[a], 8) & 0xff) | 256] + this[b]) >>> 0;
        this[a] = rotr(this[a], 24);
        this[c] = (this[c] + this.s_box[this.r]) >>> 0;
        this[d] = (this.s_box[(this[a] & 0xff) | 256] ^ this[d]) >>> 0;
    }
    ;
    b_mix(a, b, c, d) {
        this.r = rotl(this[a], 16);
        this[b] = ((this.s_box[(this[a] & 0xff) | 256]) ^ this[b]) >>> 0;
        this[c] = (this[c] - this.s_box[rotl(this[a], 8) & 0xff]) >>> 0;
        this[a] = rotl(this[a], 24);
    ...
    r_ktr(a, b, c, d, i) {
        ...
        this[c] = (this[c] - rotl(this.m, this.r)) >>> 0;
        this.r = rotl(this.r, 5);
        this.l = (this.l ^ this.r) >>> 0;
        this[d] = (this[d] ^ this.r) >>> 0;
        this[b] = (this[b] - rotl(this.l, this.r)) >>> 0;
    }
    ;
    /**
