...
class ARIA {
    constructor() {
        ...
        this.SB2_$LI$ = function () { if (this.SB2 == null) {
        ...
        this.SB3_$LI$ = function () { if (this.SB3 == null) {
        ...
        this.SB4_$LI$ = function () { if (this.SB4 == null) {
        ...
        this.ROL = function (array, nShift) {
        ...
        this.ROR = function (array, nShift) {
            return this.ROL(array, (array.length * 8) - nShift);
        };

        this.unsigned = function (b) {
            return b & 255;
        };
         ...
         * @private
         */
        /*private*/ this.SL1 = function (array) {
         ...
         * @private
         */
        /*private*/ this.SL2 = function (array) {
            var result = new Uint8Array(16)
         ...
         * @private
         */
        /*private*/ this.FE = function (D, RK) {
            return this.A(this.SL2(this.XOR(D, RK)));
        };
        /*private*/ this.A = function (b) {
            var length = b.length;
            if (length !== 16) {
        ...
        /*private*/ this.scheduleKey = function (key) {
        ...
        /*private*/ this.encrypt_block = function (start_chunk) {

            let text = start_chunk;
            if (this.iv_set == true) {
                text = this.XOR(start_chunk, this.iv);
            }
        ...
        /*private*/ this.decrypt_block = function (start_chunk) {
