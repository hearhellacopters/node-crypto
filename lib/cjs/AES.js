...
class AES {
     ...
     */
    set_key(key_data) {
        if (!(0, common_js_1.isBufferOrUint8Array)(key_data)) {
    ...
    encrypt_block(start_chunk) {
        ...
        if (this.iv_set == true) {
            block = (0, common_js_1.xor)(start_chunk, this.iv);
        }
        ...
        if ((0, common_js_1.isBuffer)(start_chunk)) {
    ...
    decrypt_block(start_chunk) {
        ...
        if (this.iv_set == true) {
            return_buffer = (0, common_js_1.xor)(block_out, this.iv);
        }
