...
class TWOFISH {
    ...
    F() {
        ...
        var x11, x12, x13;
        do {
            x11 = (0, common_1.HIBYTE)(x2);
            x12 = (0, common_1.__PAIR64__)(x2, x1, 24);
            x1 = (x1 << 8) >>> 0;
            x13 = (2 * (0, common_1.HIBYTE)(x2)) >>> 0;
            if ((x2 & 0x80000000) != 0) {
                x13 = (x13 ^ 0x14D) >>> 0;
            }
    ...
    set_key(key) {
        ...
        for (let i = 0; i < 256; i++) {
            const element = (0, common_1.readUInt32LE)(this.MDS_1, i * 4);
            temp_MDS1[i] = element;
        }
        this.MDS_table.push(temp_MDS1);
        const temp_MDS2 = new Uint32Array(256);
        for (let i = 0; i < 256; i++) {
            const element = (0, common_1.readUInt32LE)(this.MDS_2, i * 4);
            temp_MDS2[i] = element;
        }
        this.MDS_table.push(temp_MDS2);
        const temp_MDS3 = new Uint32Array(256);
        for (let i = 0; i < 256; i++) {
            const element = (0, common_1.readUInt32LE)(this.MDS_3, i * 4);
            temp_MDS3[i] = element;
        }
        this.MDS_table.push(temp_MDS3);
        const temp_MDS4 = new Uint32Array(256);
        for (let i = 0; i < 256; i++) {
            const element = (0, common_1.readUInt32LE)(this.MDS_4, i * 4);
            temp_MDS4[i] = element;
        }
        ...
        do {
            ...
            let temp = this.F();
            (0, common_1.writeUInt32LE)(this.final_keys, temp >>> 0, one * 4);
            ++i_0;
            one_0 += 2;
            --one;
        } while (i_0 < two);
        ...
        for (i = 0; i < 40; i += 2) {
            A = this.h(i, 0);
            B = this.h(i + 1, 4);
            B = (0, common_1.rotl)(B, 8);
            A += B;
            B += A;
            (0, common_1.writeUInt32LE)(this.buffer, A >>> 0, i * 4);
            (0, common_1.writeUInt32LE)(this.buffer, (0, common_1.rotl)(B, 9), (i * 4) + 4);
            this.l_key[i] = A >>> 0;
            this.l_key[i + 1] = (0, common_1.rotl)(B, 9);
        }
    ...
    ENCRYPT_CYCLE(offset) {
        var keys = this.keys;
        let x8 = (((this.block2[(0, common_1.BYTE1)(keys[0])] ^ this.block1[(0, common_1.BYTE)(keys[0])]) >>> 0 ^ this.block3[(0, common_1.BYTE2)(keys[0])]) >>> 0 ^ this.block4[(0, common_1.HIBYTE)(keys[0])]) >>> 0;
        let x9 = (((this.block2[(0, common_1.BYTE)(keys[1])] ^ this.block1[(0, common_1.HIBYTE)(keys[1])]) >>> 0 ^ this.block3[(0, common_1.BYTE1)(keys[1])]) >>> 0 ^ this.block4[(0, common_1.BYTE2)(keys[1])]) >>> 0;
        let x26 = (x8 + 2 * x9 + this.l_key[4 * (offset) + 9]) >>> 0;
        keys[2] = (0, common_1.rotr)((keys[2] ^ (x9 + x8 + this.l_key[4 * (offset) + 8]) >>> 0) >>> 0, 1);
        let x0 = (0, common_1.rotl)(keys[3], 1);
        keys[3] = (x0 ^ x26) >>> 0;
        let x10 = (4 * offset) | 2;
        let x9_1 = (((this.block2[(0, common_1.BYTE1)(keys[2])] ^ this.block1[(0, common_1.BYTE)(keys[2])]) >>> 0 ^ this.block3[(0, common_1.BYTE2)(keys[2])]) >>> 0 ^ this.block4[(0, common_1.HIBYTE)(keys[2])]) >>> 0;
        let x8_1 = (((this.block2[(0, common_1.BYTE)(keys[3])] ^ this.block1[(0, common_1.HIBYTE)(keys[3])]) >>> 0 ^ this.block3[(0, common_1.BYTE1)(keys[3])]) >>> 0 ^ this.block4[(0, common_1.BYTE2)(keys[3])]) >>> 0;
        let x20 = (x9_1 + 2 * x8_1 + this.l_key[x10 + 9]) >>> 0;
        keys[0] = (0, common_1.rotr)(keys[0] ^ (x8_1 + x9_1 + this.l_key[x10 + 8]), 1);
        keys[1] = (0, common_1.rotl)(keys[1], 1) ^ x20;
        this.keys = keys;
    }
    ;
    DECRYPT_CYCLE(offset) {
        var keys = this.keys;
        let v6 = (4 * offset) | 2;
        let v9 = (((this.block2[(0, common_1.BYTE1)(keys[0])] ^ this.block1[(0, common_1.BYTE)(keys[0])]) >>> 0 ^ this.block3[(0, common_1.BYTE2)(keys[0])]) >>> 0 ^ this.block4[(0, common_1.HIBYTE)(keys[0])]) >>> 0;
        let v10 = 4 * offset;
        let v11 = (((this.block2[(0, common_1.BYTE)(keys[1])] ^ this.block1[(0, common_1.HIBYTE)(keys[1])]) >>> 0 ^ this.block3[(0, common_1.BYTE1)(keys[1])]) >>> 0 ^ this.block4[(0, common_1.BYTE2)(keys[1])]) >>> 0;
        let v13 = (v11 + v9 + this.l_key[v6 + 8]) >>> 0;
        let v14 = (v9 + 2 * v11 + this.l_key[v6 + 9]) >>> 0;
        keys[2] = (0, common_1.rotl)(keys[2], 1) ^ v13;
        let v15 = (0, common_1.rotr)(keys[3] ^ v14, 1);
        keys[3] = v15;
        let v16 = (((this.block2[(0, common_1.BYTE1)(keys[2])] ^ this.block1[(0, common_1.BYTE)(keys[2])]) >>> 0 ^ this.block3[(0, common_1.BYTE2)(keys[2])]) >>> 0 ^ this.block4[(0, common_1.HIBYTE)(keys[2])]) >>> 0;
        let v17 = (((this.block2[(0, common_1.BYTE)(v15)] ^ this.block1[(0, common_1.HIBYTE)(v15)]) >>> 0 ^ this.block3[(0, common_1.BYTE1)(v15)]) >>> 0 ^ this.block4[(0, common_1.BYTE2)(v15)]) >>> 0;
        let v18 = (v17 + v16 + this.l_key[v10 + 8]) >>> 0;
        let v19 = (v16 + 2 * v17 + this.l_key[v10 + 9]) >>> 0;
        keys[0] = (0, common_1.rotl)(keys[0], 1) ^ v18;
        keys[1] = (0, common_1.rotr)(keys[1] ^ v19, 1);
        this.keys = keys;
    }
    ;
    encrypt_block(block) {
        ...
        var make_keys = (0, common_1.xor)(start_chunk, this.xor_in);
        this.keys = new Uint32Array(4);
        for (let i = 0; i < 4; i++) {
            const element = (0, common_1.readUInt32LE)(make_keys, i * 4);
            this.keys[i] = element;
        }
        ...
        (0, common_1.writeUInt32LE)(out_blk, this.keys[2], 0);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[3], 4);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[0], 8);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[1], 12);
        out_blk = (0, common_1.xor)(out_blk, this.xor_out);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
    ...
    decrypt_block(block) {
        ...
        var make_keys = (0, common_1.xor)(start_chunk, this.xor_out);
        this.keys = new Uint32Array(4);
        for (let i = 0; i < 4; i++) {
            const element = (0, common_1.readUInt32LE)(make_keys, i * 4);
            this.keys[i] = element;
        ...
        (0, common_1.writeUInt32LE)(out_blk, this.keys[2] >>> 0, 0);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[3] >>> 0, 4);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[0] >>> 0, 8);
        (0, common_1.writeUInt32LE)(out_blk, this.keys[1] >>> 0, 12);
        out_blk = (0, common_1.xor)(out_blk, this.xor_in);
