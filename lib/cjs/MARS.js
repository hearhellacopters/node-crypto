...
class MARS {
    constructor() {
        this.key_set = false;
        this.iv_set = false;
        this.s_box = new Uint32Array(512);
        this.vk = new Uint32Array(47);
        this.l_key = new Uint32Array(40);
        this.b_tab = new Uint32Array(4);
    }
    f_mix(a, b, c, d) {
        this.r = (0, common_js_1.rotr)(this[a], 16) & 0xff;
        this[b] = (this.s_box[this[a] & 0xff] ^ this[b]);
        this[b] = (this.s_box[((0, common_js_1.rotr)(this[a], 8) & 0xff) | 256] + this[b]) >>> 0;
        this[a] = (0, common_js_1.rotr)(this[a], 24);
        this[c] = (this[c] + this.s_box[this.r]) >>> 0;
        this[d] = (this.s_box[(this[a] & 0xff) | 256] ^ this[d]) >>> 0;
    }
    ;
    b_mix(a, b, c, d) {
        this.r = (0, common_js_1.rotl)(this[a], 16);
        this[b] = ((this.s_box[(this[a] & 0xff) | 256]) ^ this[b]) >>> 0;
        this[c] = (this[c] - this.s_box[(0, common_js_1.rotl)(this[a], 8) & 0xff]) >>> 0;
        this[a] = (0, common_js_1.rotl)(this[a], 24);
        this[d] = ((this.s_box[this[a] & 0xff] ^ (this[d] - this.s_box[(this.r & 0xff) | 256])) >>> 0);
    }
    ;
    f_ktr(a, b, c, d, i) {
        const val_pull1 = (0, common_js_1.readUInt32LE)(this.buffer, i * 4);
        this.m = (val_pull1 + this[a]);
        this[a] = (0, common_js_1.rotl)(this[a], 13);
        this.l = this.s_box[this.m & 511];
        const val_pull2 = (0, common_js_1.readUInt32LE)(this.buffer, (i + 1) * 4);
        this.r = (0, common_js_1.rotl)(multiplyInt(val_pull2, this[a]), 5);
        this[c] = ((0, common_js_1.rotl)(this.m, this.r)) + this[c] >>> 0;
        this.l = (this.r ^ this.l) >>> 0;
        this.r = (0, common_js_1.rotl)(this.r, 5) >>> 0;
        this[d] = (this.r ^ this[d]) >>> 0;
        this[b] = (this[b] + (0, common_js_1.rotl)((this.l ^ this.r) >>> 0, this.r)) >>> 0;
    }
    ;
    r_ktr(a, b, c, d, i) {
        const val_pull1 = (0, common_js_1.readUInt32LE)(this.buffer, (i + 1) * 4);
        this.r = (multiplyInt(this[a], val_pull1)) >>> 0;
        this[a] = (0, common_js_1.rotr)(this[a], 13);
        const val_pull2 = (0, common_js_1.readUInt32LE)(this.buffer, i * 4);
        this.m = (this[a] + val_pull2) >>> 0;
        this.l = (this.s_box[this.m & 511]) >>> 0;
        this.r = (0, common_js_1.rotl)(this.r, 5);
        this.l = (this.l ^ this.r) >>> 0;
        this[c] = (this[c] - (0, common_js_1.rotl)(this.m, this.r)) >>> 0;
        this.r = (0, common_js_1.rotl)(this.r, 5);
        this.l = (this.l ^ this.r) >>> 0;
        this[d] = (this[d] ^ this.r) >>> 0;
        this[b] = (this[b] - (0, common_js_1.rotl)(this.l, this.r)) >>> 0;
    }
    ;
    /**
    ...
    set_key(key) {
        ...
        for (let index = 0; index < key_len / 4; index++) {
            const element = (0, common_js_1.readUInt32LE)(key, index * 4);
        ...
        m = key_len / 4 - 1 >>> 0;
        for (i = j = 0; i < 39; ++i) {
            this.vk[i + 7] = (0, common_js_1.rotl)((this.vk[i] ^ this.vk[i + 5]) >>> 0, 3) ^ in_key[j] ^ i;
            j = (j === m ? 0 : j + 1);
        }
        this.vk[46] = key_len / 4;
        for (j = 0; j < 7; ++j) {
            for (i = 1; i < 40; ++i) {
                this.vk[i + 7] = (0, common_js_1.rotl)((this.vk[i + 7] + this.s_box[this.vk[i + 6] & 511]) >>> 0, 9);
            }
            this.vk[7] = (0, common_js_1.rotl)((this.vk[7] + this.s_box[this.vk[46] & 511]) >>> 0, 9);
        }
        for (i = j = 0; i < 40; ++i) {
        ...
        for (i = 5; i < 37; i += 2) {
            ...
            if (m) {
                ...
                m |= (m << 1) & ~w & 0x80000000;
                m &= 0xfffffffc;
                w ^= ((0, common_js_1.rotl)(this.b_tab[this.l_key[i] & 3], this.l_key[i + 3] & 31) & m);
            }
            this.l_key[i] = w;
        }
        const buffer = new Uint8Array(40 * 4);
        this.l_key.forEach((n, i) => {
            (0, common_js_1.writeUInt32LE)(buffer, n, i * 4);
        });
        this.buffer = buffer;
        this.key_set = true;
    }
    ...
    encrypt_block(block) {
        ...
        this.a = ((0, common_js_1.readUInt32LE)(start_chunk, 0) + (0, common_js_1.readUInt32LE)(this.buffer, 0)) >>> 0;
        this.b = ((0, common_js_1.readUInt32LE)(start_chunk, 4) + (0, common_js_1.readUInt32LE)(this.buffer, 4)) >>> 0;
        this.c = ((0, common_js_1.readUInt32LE)(start_chunk, 8) + (0, common_js_1.readUInt32LE)(this.buffer, 8)) >>> 0;
        this.d = ((0, common_js_1.readUInt32LE)(start_chunk, 12) + (0, common_js_1.readUInt32LE)(this.buffer, 12)) >>> 0;
        this.l = 0;
        this.m = 0;
        this.r = 0;
        let i;
        ...
        this.f_ktr("a", "b", "c", "d", 4);
        this.f_ktr("b", "c", "d", "a", 6);
        this.f_ktr("c", "d", "a", "b", 8);
        this.f_ktr("d", "a", "b", "c", 10);
        this.f_ktr("a", "b", "c", "d", 12);
        this.f_ktr("b", "c", "d", "a", 14);
        this.f_ktr("c", "d", "a", "b", 16);
        this.f_ktr("d", "a", "b", "c", 18);
        this.f_ktr("a", "d", "c", "b", 20);
        this.f_ktr("b", "a", "d", "c", 22);
        this.f_ktr("c", "b", "a", "d", 24);
        this.f_ktr("d", "c", "b", "a", 26);
        this.f_ktr("a", "d", "c", "b", 28);
        this.f_ktr("b", "a", "d", "c", 30);
        this.f_ktr("c", "b", "a", "d", 32);
        this.f_ktr("d", "c", "b", "a", 34);
        for (i = 0; i < 2; i++) {
            this.b_mix("a", "b", "c", "d");
            this.b_mix("b", "c", "d", "a");
        ...
        (0, common_js_1.writeUInt32LE)(out_blk, (this.a - (0, common_js_1.readUInt32LE)(this.buffer, 36 * 4)) >>> 0, 0);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.b - (0, common_js_1.readUInt32LE)(this.buffer, 37 * 4)) >>> 0, 4);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.c - (0, common_js_1.readUInt32LE)(this.buffer, 38 * 4)) >>> 0, 8);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.d - (0, common_js_1.readUInt32LE)(this.buffer, 39 * 4)) >>> 0, 12);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
    ...
    decrypt_block(block) {
        ...
        this.d = ((0, common_js_1.readUInt32LE)(start_chunk, 0) + (0, common_js_1.readUInt32LE)(this.buffer, 36 * 4)) >>> 0;
        this.c = ((0, common_js_1.readUInt32LE)(start_chunk, 4) + (0, common_js_1.readUInt32LE)(this.buffer, 37 * 4)) >>> 0;
        this.b = ((0, common_js_1.readUInt32LE)(start_chunk, 8) + (0, common_js_1.readUInt32LE)(this.buffer, 38 * 4)) >>> 0;
        this.a = ((0, common_js_1.readUInt32LE)(start_chunk, 12) + (0, common_js_1.readUInt32LE)(this.buffer, 39 * 4)) >>> 0;
        this.l = 0;
        this.m = 0;
        this.r = 0;
        let i;
        ...
        this.r_ktr("a", "b", "c", "d", 34);
        this.r_ktr("b", "c", "d", "a", 32);
        this.r_ktr("c", "d", "a", "b", 30);
        this.r_ktr("d", "a", "b", "c", 28);
        this.r_ktr("a", "b", "c", "d", 26);
        this.r_ktr("b", "c", "d", "a", 24);
        this.r_ktr("c", "d", "a", "b", 22);
        this.r_ktr("d", "a", "b", "c", 20);
        this.r_ktr("a", "d", "c", "b", 18);
        this.r_ktr("b", "a", "d", "c", 16);
        this.r_ktr("c", "b", "a", "d", 14);
        this.r_ktr("d", "c", "b", "a", 12);
        this.r_ktr("a", "d", "c", "b", 10);
        this.r_ktr("b", "a", "d", "c", 8);
        this.r_ktr("c", "b", "a", "d", 6);
        this.r_ktr("d", "c", "b", "a", 4);
        for (i = 0; i < 2; i++) {
            this.b_mix("a", "b", "c", "d");
            this.b_mix("b", "c", "d", "a");
            this.c = (this.c - this.b) >>> 0;
        ...
        (0, common_js_1.writeUInt32LE)(out_blk, (this.d - (0, common_js_1.readUInt32LE)(this.buffer, 0 * 4) >>> 0), 0);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.c - (0, common_js_1.readUInt32LE)(this.buffer, 1 * 4) >>> 0), 4);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.b - (0, common_js_1.readUInt32LE)(this.buffer, 2 * 4) >>> 0), 8);
        (0, common_js_1.writeUInt32LE)(out_blk, (this.a - (0, common_js_1.readUInt32LE)(this.buffer, 3 * 4) >>> 0), 12);
