...
const ShortSwitch = (a1) => {
    ...
    const return_buffer = (0, common_1.readUInt16LE)(new Uint8Array([value1, value2]), 0);
...
class MISTY1 {
     ...
     */
    set_key(key) {
        if (!(0, common_1.isBufferOrUint8Array)(key)) {
        ...
        for (i = 0; i < 8; i++) {
            ...
            (0, common_1.writeUInt16LE)(this.buffer, value, i * 2);
        }
        let result = value;
        let v5 = (0, common_1.readUInt16LE)(this.buffer, 0);
        let v6 = (0, common_1.readUInt16LE)(this.buffer, 2);
        ...
        let v12 = v9 ^ v7;
        (0, common_1.writeUInt16LE)(this.buffer, v9 & 0xFFFF, 48);
        v9 = (v12 ^ (v9 << 9)) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v12 & 0xFFFF, 32);
        let v13 = v8 ^ v10;
        let v14 = v13 & 127 ^ v11;
        let v15 = (0, common_1.readUInt16LE)(this.buffer, 4);
        let v16 = v14 ^ (v15 >> 9);
        v13 = this.Misty1Const[v15 & 511 ^ v13] & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v9 & 0xFFFF, 16);
        v9 = (v16 ^ v13) & 0xFFFF;
        v13 = (v16 ^ v13 ^ (v16 << 9)) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v16 & 0xFFFF, 50);
        let v17 = this.Misty1Const[v15 >> 7];
        (0, common_1.writeUInt16LE)(this.buffer, v9 & 0xFFFF, 34);
        let v18 = v17 ^ v15 & 127;
        let v19 = v18 & 127 ^ this.Misty1_setup[v15 & 127];
        let v20 = (0, common_1.readUInt16LE)(this.buffer, 6);
        let v21 = v19 ^ (v20 >> 9);
        (0, common_1.writeUInt16LE)(this.buffer, result & 0xFFFF, 14);
        (0, common_1.writeUInt16LE)(this.buffer, v13 & 0xFFFF, 18);
        v18 = (v21 ^ this.Misty1Const[v20 & 511 ^ v18]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v21 & 0xFFFF, 52);
        (0, common_1.writeUInt16LE)(this.buffer, v18 & 0xFFFF, 36);
        (0, common_1.writeUInt16LE)(this.buffer, (v18 ^ (v21 << 9)) & 0xFFFF, (62 * 2) - 104);
        let v22 = this.Misty1Const[v20 >> 7] ^ v20 & 127;
        let v23 = (0, common_1.readUInt16LE)(this.buffer, (56 * 2) - 104);
        let v24 = v22 & 127 ^ this.Misty1_setup[v20 & 127] ^ (v23 >> 9);
        v22 = (v24 ^ this.Misty1Const[v23 & 511 ^ v22]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v24 & 0xFFFF, (79 * 2) - 104);
        (0, common_1.writeUInt16LE)(this.buffer, v22 & 0xFFFF, (71 * 2) - 104);
        v22 = (v22 ^ (v24 << 9)) & 0xFFFF;
        let v25 = this.Misty1Const[v23 >> 7];
        (0, common_1.writeUInt16LE)(this.buffer, v22 & 0xFFFF, (63 * 2) - 104);
        let v26 = v25 ^ v23 & 127;
        let v27 = v26 & 127 ^ this.Misty1_setup[v23 & 127];
        let v28 = (0, common_1.readUInt16LE)(this.buffer, (57 * 2) - 104);
        let v29 = v27 ^ (v28 >> 9);
        v26 = (v29 ^ this.Misty1Const[v28 & 511 ^ v26]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v29 & 0xFFFF, (80 * 2) - 104);
        (0, common_1.writeUInt16LE)(this.buffer, v26 & 0xFFFF, (72 * 2) - 104);
        (0, common_1.writeUInt16LE)(this.buffer, (v26 ^ (v29 << 9)) & 0xFFFF, (64 * 2) - 104);
        let v30 = this.Misty1Const[v28 >> 7] ^ v28 & 127;
        let v31 = (0, common_1.readUInt16LE)(this.buffer, (58 * 2) - 104);
        let v32 = v30 & 127 ^ this.Misty1_setup[v28 & 127] ^ (v31 >> 9);
        (0, common_1.writeUInt16LE)(this.buffer, v32 & 0xFFFF, (81 * 2) - 104);
        v30 = (v32 ^ this.Misty1Const[v31 & 511 ^ v30]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v30 & 0xFFFF, (73 * 2) - 104);
        (0, common_1.writeUInt16LE)(this.buffer, (v30 ^ (v32 << 9)) & 0xFFFF, (65 * 2) - 104);
        let v33 = this.Misty1Const[v31 >> 7] ^ v31 & 127;
        let v34 = this.Misty1_setup[v31 & 127] ^ (((result) >>> 0) >> 9) ^ v33 & 127;
        (0, common_1.writeUInt16LE)(this.buffer, v34 & 0xFFFF, (82 * 2) - 104);
        v33 = (v34 ^ this.Misty1Const[result & 511 ^ (v33 >>> 0)]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v33 & 0xFFFF, (74 * 2) - 104);
        (0, common_1.writeUInt16LE)(this.buffer, (v33 ^ ((v34 & 0xFFFF) << 9)) & 0xFFFF, 28);
        v33 = (this.Misty1Const[((result) >>> 0) >> 7] ^ result & 127) & 0xFFFF;
        let v35 = this.Misty1_setup[result & 127] ^ (v5 >> 9) ^ v33 & 127;
        (0, common_1.writeUInt16LE)(this.buffer, (this.Misty1_setup[result & 127] ^ ((v5 >> 9) & 0xFFFF) ^ v33 & 127) & 0xFFFF, 62);
        v5 = (v35 ^ this.Misty1Const[v5 & 511 ^ (v33 & 0xFFFF)]) & 0xFFFF;
        (0, common_1.writeUInt16LE)(this.buffer, v5 & 0xFFFF, 46);
        (0, common_1.writeUInt16LE)(this.buffer, (v5 ^ (v35 << 9)) & 0xFFFF, 30);
        this.key_set = true;
    }
    ;
    encrypt_block(block) {
        ...
        if (this.iv_set == true) {
            start_chunk = (0, common_1.xor)(block, this.iv);
        }
        let letter = "a";
        let i;
        for (i = 0; i < 4; i++) {
        ...
        let v8 = (0, common_1.readUInt16LE)(this.buffer, (52 * 2) - 104);
        let v9 = v8 & this.a ^ this.b;
        let v139 = (0, common_1.readUInt16LE)(this.buffer, (62 * 2) - 104); // correct
        let v10 = v139 & this.c ^ this.d;
        let v11 = ((0, common_1.readUInt16LE)(this.buffer, (66 * 2) - 104) | v9) ^ this.a;
        let v12 = (0, common_1.readUInt16LE)(this.buffer, (56 * 2) - 104);
        let v13 = ((v11 & 0xff) ^ (v8 & 0xff)) & 127 ^ this.Misty1Const[((v11 ^ v8) & 0xFFFF) >> 7];
        let v14 = v13 ^ this.Misty1_setup[((v11 & 0xFF) ^ (v8 & 0xFF)) & 127];
        this.a = (0, common_1.readUInt16LE)(this.buffer, (73 * 2) - 104);
        let v15 = (0, common_1.readUInt16LE)(this.buffer, (81 * 2) - 104);
        let v16 = this.Misty1Const[(v13 ^ this.a) & 0xFFFF] ^ v9 ^ (v15 ^ v14) & 127 ^ ((v15 ^ v14) << 9);
        let v17 = (0, common_1.readUInt16LE)(this.buffer, (54 * 2) - 104);
        let v18 = (v17 ^ v9) & 127;
        let v19 = v18 ^ this.Misty1Const[((v17 ^ v9) & 0xFFFF) >> 7];
        let v20 = v19 ^ this.Misty1_setup[v18];
        let v137 = (0, common_1.readUInt16LE)(this.buffer, (69 * 2) - 104);
        let v136 = (0, common_1.readUInt16LE)(this.buffer, (77 * 2) - 104);
        let v21 = v16 ^ this.Misty1Const[(v19 ^ v137) & 0xFFFF] ^ (v136 ^ v20) & 127 ^ ((v136 ^ v20) << 9);
        let v22 = (0, common_1.readUInt16LE)(this.buffer, (59 * 2) - 104);
        v16 = (v22 ^ v16) & 0xFFFF;
        let v23 = (v16 & 0xFFFF) >> 7;
        let v24 = v16 & 127;
        let v25 = v24 ^ this.Misty1Const[v23];
        let v26 = v25 ^ this.Misty1_setup[v24];
        let v132 = (0, common_1.readUInt16LE)(this.buffer, (79 * 2) - 104);
        let v133 = (0, common_1.readUInt16LE)(this.buffer, (71 * 2) - 104);
        let v27 = v10 & ~v12 ^ this.c ^ v21;
        let v28 = v21 ^ v10 ^ this.Misty1Const[(v25 ^ v133) & 0xFFFF] ^ (v132 ^ v26) & 127 ^ ((v132 ^ v26) << 9);
        let v29 = (0, common_1.readUInt16LE)(this.buffer, (53 * 2) - 104);
        let v30 = (v29 ^ v27) & 127;
        let v31 = this.Misty1_setup[v30];
        let v32 = v30 ^ this.Misty1Const[((v29 ^ v27) & 0xFFFF) >> 7];
        let v33 = (0, common_1.readUInt16LE)(this.buffer, (74 * 2) - 104);
        let v34 = (0, common_1.readUInt16LE)(this.buffer, (82 * 2) - 104);
        let v35 = this.Misty1Const[(v32 ^ v33) & 0xFFFF] ^ v28 ^ (v34 ^ v32 ^ v31) & 127 ^ ((v34 ^ v32 ^ v31) << 9);
        let v36 = (0, common_1.readUInt16LE)(this.buffer, (55 * 2) - 104);
        let v37 = (v36 ^ v28) & 127;
        let v38 = v37 ^ this.Misty1Const[((v36 ^ v28) & 0xFFFF) >> 7];
        let v39 = v38 ^ this.Misty1_setup[v37];
        let v135 = (0, common_1.readUInt16LE)(this.buffer, (70 * 2) - 104);
        let v134 = (0, common_1.readUInt16LE)(this.buffer, (78 * 2) - 104);
        let v40 = this.Misty1Const[((v38 ^ v135) & 0xFFFF)] ^ v35 ^ (v134 ^ v39) & 127 ^ ((v134 ^ v39) << 9);
        v35 = (v35 ^ v8) & 0xFFFF;
        let v41 = (v35 & 0xFFFF) >> 7;
        let v42 = v35 & 127;
        let v43 = v42 ^ this.Misty1Const[v41];
        let v44 = (0, common_1.readUInt16LE)(this.buffer, (72 * 2) - 104);
        let v45 = (0, common_1.readUInt16LE)(this.buffer, (80 * 2) - 104);
        let v46 = v45 ^ v43 ^ this.Misty1_setup[v42];
        let v47 = (0, common_1.readUInt16LE)(this.buffer, (57 * 2) - 104);
        let v48 = v40 ^ v11 ^ v47;
        let v49 = this.Misty1Const[((v44 ^ v43) & 0xFFFF)] ^ v9 ^ v40 ^ v46 & 127 ^ (v46 << 9) ^ v48 & v29;
        let v50 = ((0, common_1.readUInt16LE)(this.buffer, (63 * 2) - 104) & v27 & 0xFFFF) ^ v28;
        let v51 = (v49 | (0, common_1.readUInt16LE)(this.buffer, (67 * 2) - 104)) ^ v48;
        let v52 = (v51 ^ v17) & 127;
        let v53 = v52 ^ this.Misty1Const[((v51 ^ v17) & 0xFFFF) >> 7];
        let v54 = v53 ^ this.Misty1_setup[v52];
        this.d = (0, common_1.readUInt16LE)(this.buffer, (75 * 2) - 104);
        let v55 = (0, common_1.readUInt16LE)(this.buffer, (83 * 2) - 104);
        ...
        let v67 = (0, common_1.readUInt16LE)(this.buffer, (58 * 2) - 104);
        let v68 = v60 ^ v67 ^ v61;
        let v69 = v66 ^ v61 ^ (v15 ^ v65) & 127 ^ ((v15 ^ v65) << 9);
        let v70 = (v68 ^ v36) & 127;
        let v71 = v70 ^ this.Misty1Const[((v68 ^ v36) & 0xFFFF) >> 7];
        let v72 = v71 ^ this.Misty1_setup[v70];
        v12 = (0, common_1.readUInt16LE)(this.buffer, (68 * 2) - 104);
        v9 = (v71 ^ v12) & 0xFFFF;
        let v73 = (0, common_1.readUInt16LE)(this.buffer, (76 * 2) - 104);
        ...
        let v83 = v69 ^ (((0, common_1.readUInt16LE)(this.buffer, (64 * 2) - 104) & v68) & 0xFFFFF);
        let v84 = (v82 | (0, common_1.readUInt16LE)(this.buffer, (60 * 2) - 104)) ^ v80;
        let v85 = (0, common_1.readUInt16LE)(this.buffer, (56 * 2) - 104);
        let v86 = (v84 ^ v85) & 127;
        ...
        let v108 = v96 ^ v93 & (0, common_1.readUInt16LE)(this.buffer, (65 * 2) - 104);
        let v109 = (v107 | (0, common_1.readUInt16LE)(this.buffer, (61 * 2) - 104)) ^ v105;
        ...
        v126 = (v125 ^ this.Misty1Const[(v116 ^ v44) & 0xFFFF] ^ ((0, common_1.readUInt16LE)(this.buffer, (80 * 2) - 104) ^ v126) & 127 ^ (((0, common_1.readUInt16LE)(this.buffer, (80 * 2) - 104) ^ (v126 & 0xFFFF)) << 9)) & 0xFFFF;
        ...
        v92 = (v125 ^ v124 & (0, common_1.readUInt16LE)(this.buffer, (66 * 2) - 104)) & 0xFFFF;
        v69 = (((v2 & 0xFFFF) | v139) ^ v109) & 0xFFFF;
        let final = ((v92 | (0, common_1.readUInt16LE)(this.buffer, (52 * 2) - 104)) ^ v124) & 0xFFFF;
        //swtch a , b , c , d bytes
        var out_blk;
        if ((0, common_1.isBuffer)(block)) {
            out_blk = Buffer.alloc(8);
        }
        else {
            out_blk = new Uint8Array(8);
        }
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(final), 0);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v92), 2);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v69), 4);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v2 & 0xFFFF), 6);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
    ...
    decrypt_block(block) {
        ...
        let v139 = (0, common_1.readUInt16LE)(this.buffer, (52 * 2) - 104);
        let v8 = (v139 | this.b) ^ this.a;
        let v146 = (0, common_1.readUInt16LE)(this.buffer, (62 * 2) - 104);
        let v9 = (v146 | this.d) ^ this.c;
        let v145 = (0, common_1.readUInt16LE)(this.buffer, (66 * 2) - 104);
        let v10 = v145 & v8 ^ this.b;
        let v11 = (0, common_1.readUInt16LE)(this.buffer, (56 * 2) - 104);
        let v12 = (0, common_1.readUInt16LE)(this.buffer, (59 * 2) - 104);
        let v13 = (v12 ^ v8) & 127;
        let v14 = this.Misty1_setup[v13];
        let v15 = v13 ^ this.Misty1Const[((v12 ^ v8) & 0xFFFF) >> 7];
        let v144 = (0, common_1.readUInt16LE)(this.buffer, (72 * 2) - 104);
        let v143 = (0, common_1.readUInt16LE)(this.buffer, (80 * 2) - 104);
        let v16 = this.Misty1Const[(v15 ^ v144) & 0xFFFF] ^ v10 ^ (v143 ^ v15 ^ v14) & 127 ^ ((v143 ^ v15 ^ v14) << 9);
        let v2 = (0, common_1.readUInt16LE)(this.buffer, (53 * 2) - 104);
        let v17 = (v2 ^ v10) & 127;
        let v18 = v17 ^ this.Misty1Const[(((v2 & 0XFFFF) ^ v10) & 0XFFFF) >> 7];
        let v19 = v18 ^ this.Misty1_setup[v17];
        this.c = (0, common_1.readUInt16LE)(this.buffer, (68 * 2) - 104);
        let v20 = (0, common_1.readUInt16LE)(this.buffer, (76 * 2) - 104);
        let v21 = this.Misty1Const[(v18 ^ this.c) & 0xFFFF] ^ v16 ^ (v20 ^ v19) & 127 ^ ((v20 ^ v19) << 9);
        let v22 = (0, common_1.readUInt16LE)(this.buffer, (58 * 2) - 104);
        v16 = (v22 ^ v16) & 0xFFFF;
        let v23 = (v16 & 0xFFFF) >> 7;
        let v24 = v16 & 127;
        ...
        let v27 = v26 ^ v25;
        let v28 = (0, common_1.readUInt16LE)(this.buffer, (78 * 2) - 104);
        let v140 = (0, common_1.readUInt16LE)(this.buffer, (70 * 2) - 104);
        let v29 = this.Misty1Const[(v26 ^ v140) & 0xFFFF];
        let v30 = (0, common_1.readUInt16LE)(this.buffer, (55 * 2) - 104);
        let v31 = v21 ^ v9 ^ v30;
        ...
        let v142 = (0, common_1.readUInt16LE)(this.buffer, (71 * 2) - 104);
        let v141 = (0, common_1.readUInt16LE)(this.buffer, (79 * 2) - 104);
        ...
        let v39 = v38 ^ this.Misty1_setup[v37];
        let v40 = (0, common_1.readUInt16LE)(this.buffer, (75 * 2) - 104);
        let v41 = (0, common_1.readUInt16LE)(this.buffer, (83 * 2) - 104);
        let v42 = v36 ^ this.Misty1Const[(v40 ^ v38) & 0XFFFF] ^ (v41 ^ v39) & 127 ^ ((v41 ^ v39) << 9);
        let v43 = (0, common_1.readUInt16LE)(this.buffer, (57 * 2) - 104);
        v36 = (v36 ^ v43) & 0XFFFF;
        let v44 = (v36 & 0XFFFF) >> 7;
        let v45 = v36 & 127;
        let v46 = this.Misty1_setup[v45];
        let v47 = v45 ^ this.Misty1Const[v44];
        v25 = (0, common_1.readUInt16LE)(this.buffer, (69 * 2) - 104);
        let v48 = this.Misty1Const[(v47 ^ v25) & 0xFFFF];
        let v49 = v47 ^ v46;
        let v50 = (0, common_1.readUInt16LE)(this.buffer, (77 * 2) - 104);
        let v51 = v42 ^ v10 ^ v48 ^ (v50 ^ v49) & 127 ^ ((v50 ^ v49) << 9);
        let v52 = (0, common_1.readUInt16LE)(this.buffer, (54 * 2) - 104);
        let v53 = v42 ^ v8 ^ v52 ^ (v51 | v12);
        let v54 = ((0, common_1.readUInt16LE)(this.buffer, (61 * 2) - 104) | v32) ^ v31;
        let v55 = ((v53 & (0, common_1.readUInt16LE)(this.buffer, (65 * 2) - 104)) & 0xFFFF) ^ v51;
        let v56 = (v53 ^ v43) & 127;
        ...
        v48 = (0, common_1.readUInt16LE)(this.buffer, (74 * 2) - 104);
        let v63 = (0, common_1.readUInt16LE)(this.buffer, (82 * 2) - 104);
        ...
        let v77 = v76 ^ this.Misty1_setup[v75];
        v68 = (0, common_1.readUInt16LE)(this.buffer, (73 * 2) - 104);
        v64 = (v76 ^ v68) & 0xFFFF;
        let v78 = (0, common_1.readUInt16LE)(this.buffer, (81 * 2) - 104);
        ...
        let v86 = (v70 | (0, common_1.readUInt16LE)(this.buffer, (60 * 2) - 104)) ^ v69;
        let v87 = ((v85 & (0, common_1.readUInt16LE)(this.buffer, (64 * 2) - 104)) & 0xFFFF) ^ v84;
        let v88 = (v85 ^ v30) & 127;
        ...
        let v117 = (v102 | (0, common_1.readUInt16LE)(this.buffer, (67 * 2) - 104)) ^ v101;
        let v118 = ((v116 & (0, common_1.readUInt16LE)(this.buffer, (63 * 2) - 104)) & 0xFFFF) ^ v115;
        ...
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(final), 0);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v11), 2);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v2), 4);
        (0, common_1.writeUInt16LE)(out_blk, ShortSwitch(v12 & 0xFFFF), 6);
        var return_buffer = out_blk;
        if (this.iv_set == true) {
            return_buffer = (0, common_1.xor)(out_blk, this.iv);
        }
        return return_buffer;
    }
    ;
