...
class SEED {
    ...
    set_key(key) {
        ...
        var t_0 = new Uint32Array(1);
        var t_1 = new Uint32Array(1);
        var t_2 = new Uint32Array(1);
        var t_3 = new Uint32Array(1);
        var t_4 = new Uint32Array(1);
        var t_5 = new Uint32Array(1);
        var key0 = new Uint32Array(1);
        var key1 = new Uint32Array(1);
        var key2 = new Uint32Array(1);
        var key3 = new Uint32Array(1);
        key0[0] = (0, common_js_1.readUInt32LE)(key, 0);
        key1[0] = (0, common_js_1.readUInt32LE)(key, 4);
        key2[0] = (0, common_js_1.readUInt32LE)(key, 8);
        key3[0] = (0, common_js_1.readUInt32LE)(key, 12);
        this.buffer = new Uint8Array(128);
        let i = 0;
        let offset = 0;
        do {
            let ks_seed = this.kc[i];
            t_0[0] = (key0[0] + key2[0] - ks_seed) >>> 0;
            t_4[0] = (key1[0] + key3[0] + ks_seed) >>> 0;
            t_1[0] = this.G((0, common_js_1.bswap32)(t_0[0]));
            t_2[0] = this.G((0, common_js_1.bswap32)(t_4[0]));
            (0, common_js_1.writeUInt32LE)(this.buffer, t_1[0], offset);
            (0, common_js_1.writeUInt32LE)(this.buffer, t_2[0], offset + 4);
            if ((i & 1) != 0) {
                t_3[0] = (0, common_js_1.__PAIR64__)(key3[0], key2[0], 24);
                key2[0] = (0, common_js_1.__PAIR64__)(key2[0], key3[0], 24);
                key3[0] = t_3[0];
            }
            else {
                t_5[0] = (0, common_js_1.__PAIR64__)(key0[0], key1[0], 8);
                key0[0] = (0, common_js_1.__PAIR64__)(key1[0], key0[0], 8);
                key1[0] = t_5[0];
            }
            i++;
            offset += 8;
    ...
    encrypt_block(block) {
        ...
        this.l0 = new Uint32Array(1);
        this.l1 = new Uint32Array(1);
        this.r0 = new Uint32Array(1);
        this.r1 = new Uint32Array(1);
        this.l0[0] = (0, common_js_1.readUInt32BE)(start_chunk, 0);
        this.l1[0] = (0, common_js_1.readUInt32BE)(start_chunk, 4);
        this.r0[0] = (0, common_js_1.readUInt32BE)(start_chunk, 8);
        this.r1[0] = (0, common_js_1.readUInt32BE)(start_chunk, 12);
        this.t1 = new Uint32Array(1);
        this.t2 = new Uint32Array(1);
        this.t4 = new Uint32Array(1);
        this.t5 = new Uint32Array(1);
        this.t6 = new Uint32Array(1);
        this.t7 = new Uint32Array(1);
        this.t8 = new Uint32Array(1);
        this.t9 = new Uint32Array(1);
        this.t10 = new Uint32Array(1);
        let i = 0;
        do {
            this.t1[0] = this.l0[0];
            this.t2[0] = this.l1[0];
            this.l0[0] = this.r0[0];
            this.l1[0] = this.r1[0];
            this.t4[0] = (0, common_js_1.readUInt32LE)(this.buffer, i) ^ this.r0[0];
            this.t5[0] = (0, common_js_1.readUInt32LE)(this.buffer, i + 4) ^ this.r1[0] ^ this.t4[0];
            this.t5[0] = (0, common_js_1.bswap32)(this.t5[0]);
            this.t6[0] = this.ss1[(0, common_js_1.BYTE2)(this.t5[0])] ^ this.ss0[(0, common_js_1.HIBYTE)(this.t5[0])] ^ this.ss2[(0, common_js_1.BYTE1)(this.t5[0])] ^ this.ss3[(0, common_js_1.BYTE)(this.t5[0])];
            this.t7[0] = this.t6[0] + this.t4[0];
            this.t7[0] = (0, common_js_1.bswap32)(this.t7[0]);
            this.t8[0] = this.ss1[(0, common_js_1.BYTE2)(this.t7[0])] ^ this.ss0[(0, common_js_1.HIBYTE)(this.t7[0])] ^ this.ss2[(0, common_js_1.BYTE1)(this.t7[0])] ^ this.ss3[(0, common_js_1.BYTE)(this.t7[0])];
            this.t9[0] = this.t8[0] + this.t6[0];
            this.t9[0] = (0, common_js_1.bswap32)(this.t9[0]);
            this.t10[0] = this.ss1[(0, common_js_1.BYTE2)(this.t9[0])] ^ this.ss0[(0, common_js_1.HIBYTE)(this.t9[0])] ^ this.ss2[(0, common_js_1.BYTE1)(this.t9[0])] ^ this.ss3[(0, common_js_1.BYTE)(this.t9[0])];
        ...
        (0, common_js_1.writeUInt32BE)(out_blk, this.r0, 0);
        (0, common_js_1.writeUInt32BE)(out_blk, this.r1, 4);
        (0, common_js_1.writeUInt32BE)(out_blk, this.l0, 8);
        (0, common_js_1.writeUInt32BE)(out_blk, this.l1, 12);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
    ...
    decrypt_block(block) {
        ...
        (0, common_js_1.writeUInt32BE)(out_blk, (this.t10[0] + this.t8[0]) ^ this.t1[0], 0);
        (0, common_js_1.writeUInt32BE)(out_blk, this.r1, 4);
        (0, common_js_1.writeUInt32BE)(out_blk, this.l0, 8);
        (0, common_js_1.writeUInt32BE)(out_blk, this.l1, 12);
