...
class IDEA {
    ...
    set_key(key) {
        ...
        for (let i = 0; i < 8; i++) {
            const element = (0, common_1.readUInt16BE)(key, i * 2);
            ek[i] = element;
        }
        for (let i = 8; i < 52; i++) {
            if ((i % 8) == 6) {
    ...
    encrypt_block(block) {
        ...
        let a = (0, common_1.readUInt16BE)(start_chunk, 0);
        let b = (0, common_1.readUInt16BE)(start_chunk, 2);
        let c = (0, common_1.readUInt16BE)(start_chunk, 4);
        let d = (0, common_1.readUInt16BE)(start_chunk, 6);
        ...
        (0, common_1.writeUInt16BE)(out_blk, a, 0);
        (0, common_1.writeUInt16BE)(out_blk, c, 2);
        (0, common_1.writeUInt16BE)(out_blk, b, 4);
        (0, common_1.writeUInt16BE)(out_blk, d, 6);
        if (this.iv_set == true) {
            this.iv = out_blk;
        }
        return out_blk;
