...
function bswap32(x) {
    var new_array = [x[3],x[2],x[1],x[0]]
    const return_buffer = readUInt32LE(new_array,0)
    return return_buffer
}

function xor_switch(x, hex2) {
    var buf1 = [x[3], x[2], x[1], x[0], x[7], x[6], x[5], x[4]]
    var buf2 = hex2
    if (isBuffer(x)) {
        buf1 = Buffer.from([x[3], x[2], x[1], x[0], x[7], x[6], x[5], x[4]]);
        buf2 = Buffer.from(hex2, 'hex');
    }
    let number = -1
...
function bswap64(x) {
    var new_buffer = [x[3], x[2], x[1], x[0], x[7], x[6], x[5], x[4]]
    if(isBuffer(x)){
...
function reverse64(x) {
    var new_buffer = [x[7], x[6], x[5], x[4], x[3], x[2], x[1], x[0]]
    if(isBuffer(x)){
...
class CAST128 {
    constructor() {
        ...
        var f = [
            function (_d, _r, _m) {
                var t = rotL((_d + _r) >>> 0, _m);
                return (((((S2[BYTE2(t)] ^ S1[HIBYTE(t)]) >>> 0) - S3[BYTE1(t)]) >>> 0) + S4[BYTE(t)]) >>> 0;
            },
            function (_d, _r, _m) {
                var t = rotL((_d ^ _r) >>> 0, _m);
                return ((S1[HIBYTE(t)] - S2[BYTE2(t)] + S3[BYTE1(t)]) ^ S4[BYTE(t)]) >>> 0;
            },
            function (_d, _r, _m) {
                var t = rotL((_r - _d) >>> 0, _m);
                return (((((S2[BYTE2(t)] + S1[HIBYTE(t)]) >>> 0) ^ S3[BYTE1(t)]) >>> 0) - S4[BYTE(t)]) >>> 0;
            }
        ];
        ...
        this.set_key = function (key) {
            ...
            for (i = 0; i < 4 * 2; i++) {
                ...
                switch (i % 4) {
                    case 0:
                        K[ki++] = S5[z[0x8]] ^ S6[z[0x9]] ^ S7[z[0x7]] ^ S8[z[0x6]] ^ S5[z[0x2]];
                        K[ki++] = S5[z[0xA]] ^ S6[z[0xB]] ^ S7[z[0x5]] ^ S8[z[0x4]] ^ S6[z[0x6]];
                        K[ki++] = S5[z[0xC]] ^ S6[z[0xD]] ^ S7[z[0x3]] ^ S8[z[0x2]] ^ S7[z[0x9]];
                        K[ki++] = S5[z[0xE]] ^ S6[z[0xF]] ^ S7[z[0x1]] ^ S8[z[0x0]] ^ S8[z[0xC]];
                        break;
                    case 1:
                        K[ki++] = S5[x[0x3]] ^ S6[x[0x2]] ^ S7[x[0xC]] ^ S8[x[0xD]] ^ S5[x[0x8]];
                        K[ki++] = S5[x[0x1]] ^ S6[x[0x0]] ^ S7[x[0xE]] ^ S8[x[0xF]] ^ S6[x[0xD]];
                        K[ki++] = S5[x[0x7]] ^ S6[x[0x6]] ^ S7[x[0x8]] ^ S8[x[0x9]] ^ S7[x[0x3]];
                        K[ki++] = S5[x[0x5]] ^ S6[x[0x4]] ^ S7[x[0xA]] ^ S8[x[0xB]] ^ S8[x[0x7]];
                        break;
                    case 2:
                        K[ki++] = S5[z[0x3]] ^ S6[z[0x2]] ^ S7[z[0xC]] ^ S8[z[0xD]] ^ S5[z[0x9]];
                        K[ki++] = S5[z[0x1]] ^ S6[z[0x0]] ^ S7[z[0xE]] ^ S8[z[0xF]] ^ S6[z[0xC]];
                        K[ki++] = S5[z[0x7]] ^ S6[z[0x6]] ^ S7[z[0x8]] ^ S8[z[0x9]] ^ S7[z[0x2]];
                        K[ki++] = S5[z[0x5]] ^ S6[z[0x4]] ^ S7[z[0xA]] ^ S8[z[0xB]] ^ S8[z[0x6]];
                        break;
                    case 3:
                        K[ki++] = S5[x[0x8]] ^ S6[x[0x9]] ^ S7[x[0x7]] ^ S8[x[0x6]] ^ S5[x[0x3]];
                        K[ki++] = S5[x[0xA]] ^ S6[x[0xB]] ^ S7[x[0x5]] ^ S8[x[0x4]] ^ S6[x[0x7]];
                        K[ki++] = S5[x[0xC]] ^ S6[x[0xD]] ^ S7[x[0x3]] ^ S8[x[0x2]] ^ S7[x[0x8]];
                        K[ki++] = S5[x[0xE]] ^ S6[x[0xF]] ^ S7[x[0x1]] ^ S8[x[0x0]] ^ S8[x[0xD]];
                        break;
                }
            }
            K.forEach((el, i) => {
