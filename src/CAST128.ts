...
export class CAST128 {
    ...
    private reBE(_x: number): number[] {
        return [(_x >>> 24) & 0xff, (_x >>> 16) & 0xff, (_x >>> 8) & 0xff, _x & 0xff];
    };

    private rotL(a1: number, a2: number): number {
        var a = a1;
        var b = a2;
